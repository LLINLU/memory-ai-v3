...
import { Brain, Sparkles, TreePine, Target, Lightbulb } from "lucide-react";

export const TreeGenerationSection = () => {
  const [searchTheme, setSearchTheme] = useState("");
  const [mode, setMode] = useState<"TED" | "FAST">("TED");
    ...
    if (result) {
      ...
      navigate("/technology-tree", {
        state: {
          ...
          fromDatabase: true,
          mode: mode, // Pass the mode to the tree view
        },
      });
    }
    ...
    <Card className="max-w-4xl mx-auto border-0 shadow-none">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <Label className="text-base font-medium">生成モード選択</Label>
          <RadioGroup
            value={mode}
            onValueChange={(value) => setMode(value as "TED" | "FAST")}
            ...
            <div className="flex items-center space-x-2 border rounded-lg p-4 hover:bg-gray-50">
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium">TED（ニーズ深掘り）</div>
            ...
            <div className="flex items-center space-x-2 border rounded-lg p-4 hover:bg-gray-50">
              ...
              <div className="flex-1">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium">FAST（シーズ深掘り）</div>
                    <div className="text-sm text-gray-600">
                      技術→How1→How2→How3+
                    </div>
                  </div>
          ...
          <div className="relative">
            ...
            >
              {isGenerating ? (
                ...
                <div className="flex items-center gap-2">ツリー生成</div>
              )}
            </Button>
          </div>{" "}
          {isGenerating && (
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1">
                  <p className="font-medium text-blue-900">
                    {mode === "FAST"
                      ? "技術シーズから実現方法を階層的に分析し、技術要素を抽出しています..."
