...
export const TwoByTwoGridIcon: React.FC<TwoByTwoGridIconProps> = ({ className = "" }) => {
  return (
    ...
    >
      ...
      <path d="M10.5 7H7.5C7.22386 7 7 7.22386 7 7.5V10.5C7 10.7761 7.22386 11 7.5 11H10.5C10.7761 11 11 10.7761 11 10.5V7.5C7 7.22386 7.22386 7 7.5 7Z" fill="#1C4ED8"/>
    </svg>
  );
};
