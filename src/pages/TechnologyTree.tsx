  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className={`flex-1 ${showSidebar && !collapsedSidebar ? 'mr-[400px]' : collapsedSidebar ? 'mr-[50px]' : ''} transition-all duration-300 overflow-auto`}>
        ...
        {/* Open Sidebar Button when sidebar is collapsed, as shown in the image */}
        {!showSidebar && collapsedSidebar && (
