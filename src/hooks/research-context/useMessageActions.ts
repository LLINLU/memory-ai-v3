...
export function useMessageActions(
  ...
  const addNextQuestion = (nextStep: number) => {
    if (nextStep < steps.length) {
      ...
      if (steps[nextStep].options && steps[nextStep].options.length > 0) {
        questionContent = React.createElement(
          "div",
          null,
          React.createElement(
            "div",
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                steps[nextStep].subtitle.map((item, i) =>
                  React.createElement(
                    "li",
                    { key: i, className: "text-gray-700 text-[14px]" },
                    item
                  )
                )
              )
          ...
          React.createElement(
            ...
            React.createElement(OptionSelection, {
  ...
  const addInitialMessage = () => {
    const initialMessage = React.createElement(
      "div",
      null,
      React.createElement(
        "p",
        { className: "mb-6" },
        "研究コンテキストを手早く定義しましょう。これらの質問に答えることで結果をより絞り込めますが、スキップしてもかまいません。"
      ),
      React.createElement(
        "div",
        { className: "flex items-start gap-4" },
      ...
      { 
        ...
        content: React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "li",
              { className: "text-gray-700 text-[16px] flex items-center" },
              React.createElement(
                "svg",
                {
                ...
                React.createElement(
                  ...
                  React.createElement(
                    "clipPath",
                    { id: "clip0_219_5" },
                    React.createElement("rect", { width: "13", height: "13", fill: "white" })
                  )
                )
              ),
